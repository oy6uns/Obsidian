...
그니깐 20 Node의 Latch는 풀어도 되겠네? 라는 판단을 내린다. ![[Img/Img/SNU GSDS Course Work/1학년 1학기 (24-2)/BKMS1(데이터베이스)/Lecture/Lec 12 (10.14)/IMG-20250416150918-2.png]]
어? 그런데, 아래 38, 44 Node는 둘 다 차 있네?
그러면 일단 상위에 비어있는 35 Node도 일단은 잡고 있어야 겠다. 
![[Img/Img/SNU GSDS Course Work/1학년 1학기 (24-2)/BKMS1(데이터베이스)/Lecture/Lec 12 (10.14)/IMG-20250416150918-3.png]]
